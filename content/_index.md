        ...
        <div class="row" style="padding-top: 20px; padding-bottom: 30px;">
         <div class="col-sm-4 d-flex justify-content-center align-items-center">
            <div class="profile-picture-container" style="width: 170px; height: 170px; border-radius: 50%; overflow: hidden;">
              ...
              <span class="status-emoji" style="position: relative; bottom: 10%; right: 10%; width: 20px; height: 20px; font-size: 12px; background: white; border-radius: 0%; border: 2px solid white;">😊</span>
            </div>
         </div>
